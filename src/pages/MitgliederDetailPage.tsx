  ...
  return (
    ...
    >
      ...
      <RecordSection title="Details" cols={2}>
        ...
        <RecordField label="Mitgliedschaftstyp" value={record.fields.mitgliedschaft_typ} format="pill" />
        <RecordField label="Mitglied seit" value={record.fields.mitglied_seit} format="date" />
        <RecordField label="Notfallkontakt Vorname" value={record.fields.notfall_vorname} format="text" />
        <RecordField label="Notfallkontakt Nachname" value={record.fields.notfall_nachname} format="text" />
        <RecordField label="Notfallkontakt Telefon" value={record.fields.notfall_telefon} format="text" />
        <RecordField label="Gesundheitliche Hinweise / Einschränkungen" value={record.fields.gesundheitshinweise} format="longtext" className="md:col-span-2" />
      </RecordSection>
