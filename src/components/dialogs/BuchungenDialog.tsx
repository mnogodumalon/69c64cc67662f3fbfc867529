...
export function BuchungenDialog({ open, onClose, onSubmit, defaultValues, mitgliederList, kurseList, enablePhotoScan = true, enablePhotoLocation = true }: BuchungenDialogProps) {
